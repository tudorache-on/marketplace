...
public class UserAuthenticationService {
    ...
    @Autowired
    public UserAuthenticationService(AuthenticationManager authenticationManager, JwtTokenUtil jwtTokenUtil, JwtUserDetailsService userDetailsService, PasswordEncoder passwordEncoder, UserMapper userMapper) {
    ...
    public ResponseEntity<?> createAuthenticationToken (JwtRequestLogIn jwtRequest) throws Exception {
        try {
    ...
    public ResponseEntity<?> createNewUser (JwtRequestSignUp jwtRequest) {
